...
def generate_random_ellipse_structure(number_of_images = 2):
    ...
    for i in range(number_of_images):
        ...
        num_x = np.random.randint(2, 4) # Number of elipses in the x direction
        num_y = np.random.randint(2, 4) # Number of elipses in the y directoin 
        ...
        for ellipse in del_ellipses:
            ...
            wedge = Wedge(centroid, r,theta1, theta2, width, facecolor="black", alpha=1)
