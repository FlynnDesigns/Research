...
from src import train, test, plot, combined
import os 
os.chdir('A:\\Research\\Research\\Machine_Learning\\U_NET\\')


def main():
    # default configuration file
    config_path = Path(__file__).absolute().parent / "config/config.yml" # No worry 
    ...
    # mode
    parser.add_argument("-m", "--mode", type=str, default="plot", help="model: train, test, plot, or combined")
    ...
    # args for testing
    parser.add_argument("--test_check_num", default='112', type=str, help="checkpoint for test")
    ...
    # running
    assert hparams.mode in ["train", "test", "plot", "combined"]
